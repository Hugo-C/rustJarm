...
mod tests {
    ...
    fn test_extract_extension_info_length_start_is_11() {
        ...
        let input_counter: u8 = 32;
        let length_start_index = usize::from(input_counter + 47);
        input_packet[length_start_index] = 11;  // Force the 11 value
    ...
    fn test_extract_extension_info_incoming_error_1() {
        ...
        let input_counter: u8 = 32;
        // Force value error
        input_packet[usize::from(input_counter+50)] = 14;
        input_packet[usize::from(input_counter+51)] = 172;
        input_packet[usize::from(input_counter+52)] = 11;
        // data[counter+50:counter+53] == b"\x0e\xac\x0b"  # TODO from hex directly
    ...
    fn test_extract_extension_info_incoming_error_2() {
        ...
        let input_counter: u8 = 32;
        // Force value error
        input_packet[usize::from(input_counter+82)] = 15;
        input_packet[usize::from(input_counter+83)] = 240;
        input_packet[usize::from(input_counter+84)] = 11;
        // data[82:85] == b"\x0f\xf0\x0b")  # TODO from hex directly
